...
app.get(['\/\/analytics/:instanceID/:branchName',
  '/analytics/:instanceID/:branchName'
], function(req, res) {
...
app.get(['\/\/editor/:instanceID/:branchName',
  '/editor/:instanceID/:branchName'
], function(req, res) {
  if (!req.session.isAuthenticated && req.app.locals.authRequired)
    res.render('login', {
      title: 'login',
...
app.get(['\/\/visualization/:instanceID/:branchName',
  '/visualization/:instanceID/:branchName'
], function(req, res) {
  if (!req.session.isAuthenticated && req.app.locals.authRequired)
    res.render('login', {
      title: 'login',
...
app.get(['\/\/querying/:instanceID/:branchName',
  '/querying/:instanceID/:branchName'
], function(req, res) {
  if (!req.session.isAuthenticated && req.app.locals.authRequired)
    res.render('login', {
      title: 'login',
...
app.get(['\/\/Imprint/:instanceID/:branchName',
  '/Imprint/:instanceID/:branchName'
], function(req, res) {
  if (!req.session.isAuthenticated && req.app.locals.authRequired)
    res.render('login', {
      title: 'login',
...
app.get(['\/\/dataProtection/:instanceID/:branchName',
  '/dataProtection/:instanceID/:branchName'
], function(req, res) {
  if (!req.session.isAuthenticated && req.app.locals.authRequired)
    res.render('login', {
      title: 'login',
...
app.use(['\/\/:instanceID/:branchName/*', '/:instanceID/:branchName/*'], referenceRoutes);

//TODO:check if it is needed or keep it commented
